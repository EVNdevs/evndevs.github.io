...
[![Extension 0.2.49, early access](https://img.shields.io/badge/extension-0.2.49%20%C2%B7%20early%20access-a8977b?style=flat-square&labelColor=111518)](https://evn.coresg.tech/#/changelog)
...
1. **Install the extension.** Download
   [`evn-alpha-micropython-0.2.49.vsix`](https://evn.coresg.tech/vsix/evn-alpha-micropython-0.2.49.vsix),
...
| :--- | :--- | :--- | :--- |
| **VS Code extension** | 0.2.49 | [`.vsix`](https://evn.coresg.tech/vsix/evn-alpha-micropython-0.2.49.vsix) | [Changelog](https://evn.coresg.tech/#/changelog) |
| **MicroPython firmware** | 0.2.49 | [`.uf2`](https://evn.coresg.tech/firmware/EVN_ALPHA_MicroPython.uf2) | [BUILD.txt](firmware/BUILD.txt) |
...
| Path | What it is |
| :--- | :--- |
| [`docs/`](docs/) | The Markdown the site renders: `GETTING_STARTED.md`, `CALIBRATION.md`, `API.md` (the API reference's index) with its parts `API_*.md`, `BLOCKS.md`, `CHANGELOG.md`. |
| [`examples/`](examples/) | The bundled example programs: one folder per object of the API (the board, the motor, the robot, the pose, every standard peripheral, UART, I2C and files, and an *Extended Peripherals* group with a folder per device), each with a minimal and a complete program, in Python and, where the object has blocks, for the block editor. |
